    ...
    <section className="paddings">
        ...
        <h2 className="mb-6 font-semibold  text-lg">Technologies  /  Languages</h2>
          <div className="grid grid-cols-4 gap-2 md:gap-5">
            <Skill imageUrl="/icons_aws.svg" enterFromLeft={true} enterFromTop={true} skillName="React"/>
            <Skill imageUrl="/icons_cockroachdb.svg" enterFromLeft={true} enterFromTop={true} skillName="React"/>
            ...
            <Skill imageUrl="/icons_heroku.svg" enterFromLeft={false} enterFromTop={false} skillName="React"/>
        ...
        <div className="flex flexCenter pt-10 pb-40">
          <div className="grid grid-cols-2 gap-0">
            ...
            <div className="md:border-r-0 md:px-10 px-6 w-full">
              ...
              <p className="text-xs text-left tracking-wider">DevOps & Software Engineering</p>
              <p className="mb-6 text-sm font-light">IBM Professional Training (in-progress)</p>
